...
import { appendInitialChild, createInstance, createTextInstance } from "react-dom/src/hostConfig";
 ...
 * @param {FiberNode} wip
 */
function appendAllChildren(parent: React.Container, wip: FiberNode) {
  let node = wip.child;
