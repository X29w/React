...
function prepareFreshStack(root: FiberRootNode, lane: React.Lane) {
...
export function scheduleUpdateOnFiber(fiber: FiberNode, lane: React.Lane) {
  // fiberRootNode
 ...
 * 处理rootNode的lanes
 */
export function markRootUpdated(root: FiberRootNode, lane: React.Lane) {
...
function markUpdateLaneFromFiberToRoot(fiber: FiberNode, lane: React.Lane) {
  let node = fiber;
...
function performConcurrentWorkOnRoot(
  ...
  console.log("-x-react-didTimeout--", didTimeout);
  ...
  switch (exitStatus) {
    ...
    case RootInComplete:
      ...
      console.log("-x-react-中断--", didTimeout);
      // 继续调度
...
function handleThrow(throwValue: any) {
  // Error  Boundary
